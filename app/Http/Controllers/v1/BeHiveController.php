...
class BeHiveController extends Controller
{
    private $file_log;
    ...
    public function index()
    {
        ...
        $beHive = \App\Models\Integrations::where('int_id', $bluIp_id)->get();

        //$Integrations = \App\Models\Integration::where('active', true)->get();
        return response()->json( $beHive, 200 );
    }
        ...
        try {
            ...
            if($integration) {
                ...
                if($integration->task_sync_enabled){
                    ...
                    dispatch($job);
                }else if($integration->contact_sync_enabled){
