    ...
    public function requestRoomStatus( Request $request ) {
        try {
            ...
            */
            ...
            else if( ($hk->front_desk_status == 1 || $hk->front_desk_status == 3 || $hk->front_desk_status == 5) &&  $hk->hk_statu == 4) {
                $generic_status = 8;

            } //Pick-up 7: [( 1 || 3 || 5 ) && ( 5 )]
            else if(($hk->front_desk_status == 1 || $hk->front_desk_status == 3 || $hk->front_desk_status == 5  ) &&  $hk->hk_statu == 5) {
                $generic_status = 7;

            } // Room Cleaned / occupied 11: [( 2 || 4 )  && ( 3 )]
            else if(($hk->front_desk_status == 2 || $hk->front_desk_status == 4) && $hk->hk_statu == 3) {
                $generic_status = 11;
                
            } // Room Cleaned / Vacant 12: [( 1 || 3 || 5 ) && ( 3 )]
            else if(( $hk->front_desk_status == 1 || $hk->front_desk_status == 2 || $hk->front_desk_status == 3) &&  $hk->hk_statu == 3) {
                $generic_status = 12;

            } // Cleaning Request | occupied 13: [( 2 || 4 ) && ( 1 )]
            else if(($hk->front_desk_status == 2 || $hk->front_desk_status == 4 ) &&  $hk->hk_statu == 1) {
                $generic_status = 13;

            } // Cleaning Request | Vacant 14: [( 1 || 3 || 5 ) && ( 1 )]
            else if(($hk->front_desk_status == 1 || $hk->front_desk_status == 3 || $hk->front_desk_status == 5) &&  $hk->hk_statu == 1) {
                $generic_status = 14;
            }
