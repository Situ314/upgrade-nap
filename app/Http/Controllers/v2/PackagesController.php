...
class PackagesController extends Controller
{
    ...
    public function store(Request $request) {
        ...
        try {
            ...
            if(!$request->exists('package')) return response()->json([ "error" => "Package object, data not provided" ], 400);
            ...
            if(isset($package['guest_id']) && !empty($package['guest_id'])) {
            ...
            } else if(isset($package["phone_no"]) && !empty($package["phone_no"])) {
                ...
                if($GuestRegistration) {
                    ...
                    if(isset($package["name"]) && !empty($package["name"])) {
                        ...
                        $_lastname = '';
                        if(count(explode(' ', $str, 2)) > 1) { $_lastname = explode(' ', $str, 2)[1]; }
