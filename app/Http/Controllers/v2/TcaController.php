...
class TcaController extends Controller
{
    public function index(Request $request)
    {
        ...
        } elseif (isset($parse->HotelCheckInNotifRQ)) {
            $_action = 'HotelCheckInNotifRQ';
        } elseif (isset($parse->HotelCheckOutNotifRQ)) {
            $_action = 'HotelCheckOutNotifRQ';
        } elseif (isset($parse->HotelRoomMoveNotifRQ)) {
     ...
     * * Canlled
     */
    private function HotelStayUpdateNotifRQ($hotel_id, $user_id, $data)
    {
        return $this->__clear($hotel_id, $user_id, $data, 'HotelStayUpdateNotifRQ');
    }

    private function HotelCheckInNotifRQ($hotel_id, $user_id, $data)
    {
        return $this->__clear($hotel_id, $user_id, $data, 'HotelCheckInNotifRQ');
    }

    private function HotelCheckOutNotifRQ($hotel_id, $user_id, $data)
    {
        return $this->__clear($hotel_id, $user_id, $data, 'HotelCheckOutNotifRQ');
    }
                                            ...
                                            if (isset($Profile->Customer)) {
                                                ...
                                                if (isset($Customer->Address)) {
                                                    ...
                                                    if (isset($Address->PostalCode)) {
                                                        $__zipcode = $Address->PostalCode;
                                                    }
                                                    if (isset($Address->CityName)) {
                                                        $__city = $Address->CityName;
                                                    }
                                                }
                                            }
                                        }
